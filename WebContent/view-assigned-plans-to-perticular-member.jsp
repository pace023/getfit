		...
		<div class="panel panel-info shadow p-3 mb-5">
			...
			<div class="panel-body">
				<table class="table table-bordered">
					...
					<%
						ResultSet resultDietPlan = DatabaseConnection.getResultFromSqlQuery("select * from tbldietplan where uname='" + session.getAttribute("uname") + "' and member_name='"+request.getParameter("memberName")+"'");
		...
		<div class="panel panel-info shadow p-3 mb-5">
			...
			<div class="panel-body">
				<table class="table table-bordered">
					...
					<%
						ResultSet resultWorkOutPlan = DatabaseConnection.getResultFromSqlQuery("select * from tblworkout where uname='" + session.getAttribute("uname") + "' and member_name='"+request.getParameter("memberName")+"'");
