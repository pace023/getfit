	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				%>
					<div class="alert alert-info" id="info">Information
				...
				<div class="panel panel-info shadow p-3 mb-5">
					...
					<div class="panel-body">
						<%
							ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from tbldietitian where did='"+ session.getAttribute("did") + "' and uname='" + session.getAttribute("uname") + "'");
							if (rs.next()) {
						%>
