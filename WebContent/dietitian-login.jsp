	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="images/trainer-login.jpg" style="width:500px;height:400px;">
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="panel panel-info shadow p-3 mb-5">
					<div class="panel-heading">Dietitian Login</div>
					<div class="panel-body">
						...
						%>
						<form action="DietitionLogin" method="post">
							...
							<a class="for-pwd" href="dietitian-account.jsp">New Dietitian Account?</a>
						</form>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(function() {
		$('#warning').delay(6000).show().fadeOut('slow');
	});
</script>
</html>